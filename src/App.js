...
import CollectionsArtesanos from './pages/explore/collections_artesanos';
...
import { isWallectConnected, getAllCollectionsAndNFts } from './Blockchain.Services'
...
function App() {
  ...
  useEffect (() => {
    ...
    const execute = async ( ) => {
      ...
      await Moralis.start({
        apiKey: "zIO02DGNELY2ZgP30TDczbC8PkiBV9nYWdgV7L3kIp6UuJgj5OtAu29FSNXQe08e",
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/buildings" element={<CollectionsBuildings />} />
        <Route path="/artesanos" element={<CollectionsArtesanos />} />
